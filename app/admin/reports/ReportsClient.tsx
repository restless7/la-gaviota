...
import { SalesAnalytics } from '@/src/actions/analytics';
...
export default function ReportsClient({ salesData, kpis }: ReportsClientProps) {
  return (
    <div className="w-full space-y-8 animate-fade-in">
      <div className="mb-4">
         <h1 className="text-3xl font-black text-slate-800 font-serif">Reportes y Trazabilidad</h1>
         <p className="text-gray-500">Métricas en tiempo real, márgenes por nivel y seguimiento de pedidos.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
            ...
            <div>
               <p className="text-sm font-bold text-gray-400 uppercase tracking-wider">Ventas Totales (Real)</p>
               <h3 className="text-2xl font-black text-slate-800">${(kpis.totalRevenue / 1_000_000).toFixed(2)}M COP</h3>
            </div>
         </div>
         <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
